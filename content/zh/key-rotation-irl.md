...
## 现场的一个业务模板示例
当天我没有在市场监督管理所找要办理的业务的模板，倒是看到了另一个模板，就拍了张照片，并手动把照片上的一些反光部分修掉了。这类模板，如果数字化电子化了，其实就是商事主体之间进行数据交换的 data schema ，通俗讲就是交换过程中数据的约束，它规定了交换的数据应该是什么类型、有哪些可选项、哪些项目是必填项等等，形成标准的电子文档，会对办理业务的人有很多帮助，希望能尽早实现。
