...
然后我又手写了几个表格，期间还有个工作人员，帮我查验了填写的信息，确保提交的资料齐全并且格式符合要求，还要去旁边的小店复印了三份身份证复印件。填完资料后，我还得重新取号，还好现场办事的人不算多。提交资料后，其实也需要在工作人员提醒的时机，用支付宝的「登记注册身份验证」程序来刷脸做实名认证，并提供手写签名，但这次好像没有要求提供使用旧的实名帐号签的名。不过工作人员办事设备端上，似乎也还能看到使用旧证签名的选项，只不过估计是可选的。
...
## 现场的一个业务模板示例
我没有在市场监督管理所找要办理的业务的模板，倒是看到了另一个模板，就拍了张照片，今天（2026-03-02）我简单校正了页面透视，并把照片上的一些反光部分修掉了。这类模板，如果数字化电子化了，其实就是商事主体之间进行数据交换的 data schema ，通俗讲就是交换过程中数据的约束，它规定了交换的数据应该是什么类型、有哪些可选项、哪些项目是必填项等等，形成标准的电子文档，会对办理业务的人有很多帮助，希望能尽早实现。
![2023.个体工商户注销登记申请书.模板](/media/2023.个体工商户注销登记申请书.模板.webp)
